...
<span style="display: inline-flex; text-overflow:inherit;margin-left:    2rem;  margin-bottom:1rem;   font-weight: bold;"> <span style="color:deepskyblue; font-size: 1rem;"></span><span style="color:antiquewhite; font-size: 1rem;"> Add Event</span> 
</span>
</div>
