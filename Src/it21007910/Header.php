...
<div id="mySidenav" class="sidenav">
  ...
  <!--menu-->
  <a href="/">🎨 Dashboard</a>
  <a href="Src/it20029586/RequestBooks.php">🕮 Add Book</a>
...
<div class="topnav1">
    ...
    <!--navigation-->
    <span style="display: inline-flex; text-overflow:inherit;margin-left:    2rem;  margin-bottom:1rem;   font-weight: bold;"> <a href="./"      style="color: #b4b9bb; padding:0px;word-spacing: 0.5rem;">👤Publisher 🞂 👤 Add Event</a>
    </span>
